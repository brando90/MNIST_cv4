...
%mdl_func_name = 'HBF1'
%cp_folder = 'cp_29mar_omj1_HBF1/'
%cp_param_files_names = 'cp_29mar_omj1_HBF1_%d.m'
%results_path = './results/r_29mar_omj1_HBF1/'

train_func_name = 'learn_HSig_SGD'
mdl_func_name = 'HSig'
cp_folder = 'cp_30mar_omj2_HSig/'
cp_param_files_names = 'cp_30mar_omj2_HSig_%d.m'
results_path = './results/r_30mar_omj2_HSig/'

%train_func_name = 'learn_HReLu_SGD'
%mdl_func_name = 'HReLu'
%cp_folder = 'cp_30mar_omj3_HReLu/'
%cp_param_files_names = 'cp_30mar_omj3_HReLu_%d.m'
%results_path = './results/r_30mar_omj3_HReLu/'
%% jobs
jobs = 5
start_centers = 10
end_centers = 250
