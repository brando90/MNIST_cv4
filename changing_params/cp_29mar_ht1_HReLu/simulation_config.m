...
sgd_errors = 1
%% locations
%cp_folder = 'cp_29mar_ht1_HBF1/'
%cp_param_files_names = 'cp_29mar_ht1_HBF1_%d.m'
%results_path = './results/r_29mar_ht1_HSig1/'

%cp_folder = 'cp_29mar_ht1_HSig/'
%cp_param_files_names = 'cp_29mar_ht1_HSig_%d.m'
%results_path = './results/r_29mar_ht1_HSig/'

cp_folder = 'cp_29mar_ht1_HReLu/'
cp_param_files_names = 'cp_29mar_ht1_HReLu_%d.m'
results_path = './results/r_29mar_ht1_HReLu/'
%% jobs
jobs = 2
start_centers = 10
end_centers = 250
