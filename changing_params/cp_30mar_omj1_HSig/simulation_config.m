...
mdl_func_name = 'HSig'
cp_folder = 'cp_30mar_omj1_HSig/'
cp_param_files_names = 'cp_30mar_omj1_HSig_%d.m'
results_path = './results/r_30mar_omj1_HSig/'

%train_func_name = 'learn_HReLu_SGD'
%mdl_func_name = 'HReLu'
%cp_folder = 'cp_30mar_omj1_HReLu/'
%cp_param_files_names = 'cp_30mar_omj1_HReLu_%d.m'
%results_path = './results/r_30mar_omj1_HReLu/'
%% jobs
jobs = 5
start_centers = 10
end_centers = 250
