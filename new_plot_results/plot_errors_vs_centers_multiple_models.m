...
plot(centers, list_train_errors_PCA, '-bo', centers, list_test_errors_PCA,'-b*', ...
    centers, list_train_errors_Sig, '-go', centers, list_test_errors_Sig, '-g*', ...
    centers, list_train_errors_HSig, '-ro', centers, list_test_errors_HSig, '-r*', ...
    centers, list_train_errors_ReLu, '-ko', centers, list_test_errors_ReLu, '-k*', ...
    centers, list_train_errors_HReLu, '-ko', centers, list_test_errors_HReLu, '-k*', ...
    centers, list_train_errors_RBF, '-mo', centers, list_test_errors_RBF, '-m*', ...
...
legend('PCA train errors','PCA test errors',...
    ...
    'RBF train errors','RBF test errors', 'HBF1 train errors','HSig test errors' ...
    );
