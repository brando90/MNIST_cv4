...
% HBF
%[ ~, list_train_errors_kernel, list_test_errors_RBF ] = collect_errors_vs_centers(results_file_name_prefix_RBF, results_file_name_prefix, num_models, 'train_error_kernel_mdl', 'test_error_kernel_mdl');
%[ ~, list_train_errors_kernel, list_test_errors_RBF ] = collect_errors_vs_centers(results_file_name_prefix_RBF, results_file_name_prefix, num_models, 'train_error_kernel_mdl', 'test_error_kernel_mdl');
%% plot figures
